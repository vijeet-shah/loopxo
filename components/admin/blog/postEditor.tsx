...
export function PostEditor({
  ...
  const availableLanguages = Object.keys(languageNames) as SupportedLanguage[];
  const [translations, setTranslations] = useState<
    Record<string, PostFormData>
  >({});
    ...
    const fetchPostData = async () => {
      ...
      try {
        ...
        const status: TranslationStatus = {
          [defaultLanguage]: data.published ? "published" : "draft",
        };
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center">
                <Image src={""} alt="post" width={100} height={100} className="mr-2 h-5 w-5" />
                Featured Image
              </CardTitle>
            </CardHeader>
            <CardContent>
